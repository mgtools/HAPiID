...
-p specifies the top n genomes to be selected to construct a database in step to that will cover p % of<b/r> all the identified spectra during the profiling stage.
