...
ribP_elonF_proteins_dir='../data/marker_gene_proteins/'

ribP_elonF_db_file='../data/marker_gene_MSGF_search/marker_gene_all_cdHit_100_proteinSeqs.fasta'
ribP_elonF_clstr_file='../data/marker_gene_all_cdHit_100_proteinSeqs.fasta.clstr'
...
python3 extract_representative_genomes_abundanceBased_custom.py $ribP_elonF_dir$mgf_fname'.GenomeCoveringAllHEGpeptides.txt' $n_topGenomes $MSGFplus_db$mgf_fname'/' $proteomes_dir
#augment the ribosomal proteins and elongation factor proteins to the database
python3 extract_representative_ribP_elonF_proteins_custom.py $ribP_elonF_dir$mgf_fname'.GenomeCoveringAllHEGpeptides.txt' $n_topGenomes $MSGFplus_db$mgf_fname'/' $ribP_elonF_proteins_dir
