...
NCBI_ribP_elonF_dir='../data/ribP_elonF_proteins/NCBI_genomes.ribP_elonF_protSeqs/'
HBC_ribP_elonF_dir='../data/ribP_elonF_proteins/hbc_genomes.FGS_ribP_elonF_protSeqs/'
UMGS_ribP_elonF_dir='../data/ribP_elonF_proteins/umgs_genomes.FGS_ribP_elonF_protSeqs/'

ribP_elonF_db_file='../data/ribP_elonF_MSGF_search/ribP_elonF_all_cdHit_100_proteinSeqs.fasta'
ribP_elonF_clstr_file='../data/ribP_elonF_all_cdHit_100.fasta.clstr'
MSGFplus_db='/data/mstambou/human_gut_microbiota/MSGFplus_db/'

proteins2genomes_fname='../data/umgs_hgg_proteins2genomes_dic.json'
...
if [ ! -f $ribP_elonF_dir$mgf_fname'.GenomeCoveringAllHEGpeptides.txt' ]; then    
    ...
    python2 parseFDR_o.py $ribP_elonF_dir$mgf_fname'.tsv' 0.01
...
python3 extract_representative_ribP_elonF_proteins.py $ribP_elonF_dir$mgf_fname'.GenomeCoveringAllHEGpeptides.txt' $n_topGenomes $MSGFplus_db$mgf_fname'/' $NCBI_ribP_elonF_dir $HBC_ribP_elonF_dir $UMGS_ribP_elonF_dir
